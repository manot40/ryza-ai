...
(function (global) {
  ...
  var T = {
    zh: {
      ...
      'settings.tts.provider': 'TTS 服务',
      'settings.tts.provider.openai': 'OpenAI 兼容（MiMo 等）',
      'settings.tts.provider.openai-speech': 'OpenAI Speech ',
      'settings.tts.provider.qwen': 'Qwen / 百炼（DashScope 兼容）',
      'settings.tts.provider.style': 'Request payload style',
      'settings.tts.provider.style.default': 'Default ',
      'settings.tts.provider.style.audio-cpp': 'Audio.cpp ',
    ...
    ja: {
      ...
      'settings.tts.provider': 'TTS サービス',
      'settings.tts.provider.openai': 'OpenAI 互換（MiMo など）',
      'settings.tts.provider.openai-speech': 'OpenAI Speech 互換 ',
    ...
    en: {
      ...
      'settings.tts.provider': 'TTS service',
      'settings.tts.provider.openai': 'OpenAI-compatible (MiMo etc.)',
      'settings.tts.provider.openai-speech': 'OpenAI Speech ',
