    ...
    <Dialog.Content class="sm:max-w-md bg-card/95 border-border/60 text-card-foreground backdrop-blur-md">
      ...
      <div class="space-y-4 py-2">
        ...
        <div class="space-y-1.5">
          <label for="alarm-time-input" class="text-xs font-medium text-foreground">Time</label>
          <Input
            id="alarm-time-input"
            type="time"
            bind:value={formTime}
        ...
        <!-- Alarm Type -->
        <div class="space-y-1.5">
          <span class="text-xs font-medium text-foreground">Greeting Type</span>
        ...
        <!-- Voice Style -->
        <div class="space-y-1.5">
          <span class="text-xs font-medium text-foreground">Voice Style</span>
          <div class="grid grid-cols-2 gap-2">
            {#each STYLES as s}
              <Button
        ...
        <!-- Repeat Days -->
        <div class="space-y-1.5">
          <span class="text-xs font-medium text-foreground">Repeat Days</span>
